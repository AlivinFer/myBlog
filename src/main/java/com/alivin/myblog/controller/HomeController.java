...
//        this.blogBaseData(request,contentCond);//获取公共分类标签等数据
    ...
    @ResponseBody
    public <T> APIResponse<T> comment(HttpServletRequest request, HttpServletResponse response,
                               @RequestParam(name = "cid", required = true)
                               Integer cid,
                               @RequestParam(name = "coid", required = false)
                               Integer coid,
                               ...
                               String text,
                               @RequestParam(name = "_csrf_token", required = true)
                               String _csrf_token) {
